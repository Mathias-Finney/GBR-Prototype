                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('update.route')}}" class="forms-sample" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            @foreach ($terminal as $item1)
                            <option value="{{$item1->id}}" {{ ($item1->id)? 'selected' : ''}}>{{$item1->name.' ( '. $item1->location . ' )'}}</option>
