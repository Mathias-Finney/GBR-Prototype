        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-title">EDIT BUSES</h6>

                    <form method="post" action="{{ route('update.buses')}}" class="forms-sample" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            name="reg_number" value="{{$data->reg_number}}">
                            @error('reg_number')
