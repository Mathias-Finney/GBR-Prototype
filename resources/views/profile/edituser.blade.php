...
.add-experience:hover {
  ...
  <div class="container rounded bg-white mt-5 mb-5 shadow pt-4 pb-4">
              ...
              <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                  ...
                  <div class="col-md-12 form-group">
                    ...
                    <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" placeholder="username.." value="{{ old('username') ? old('username') : Auth::user()->username }}">
                      @error('username')
                  ...
                  <div class="col-md-12 form-group">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="name.." value="{{ old('name') ? old('name') : Auth::user()->name }}">
                      @error('name')
                        <div class="text-danger">{{ $message }}</div>
                      @enderror
                  </div>
                  ...
                  <div class="col-md-12 form-group">
                    ...
                    <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="email@example.com" value="{{ old('email') ? old('email') : Auth::user()->email }}">
                      @error('email')
                        <div class="text-danger">{{ $message }}</div>
                      @enderror
                  </div>
                  ...
                  <div class="col-md-12 form-group">
                    ...
                    <input type="text" name="address" class="form-control @error('address') is-invalid @enderror" placeholder="address.." value="{{ old('address') ? old('address') : Auth::user()->address }}">
                      @error('address')
                        <div class="text-danger">{{ $message }}</div>
                      @enderror
                  </div>
                  ...
                  <div class="col-md-12 form-group">
                      ...
                      <div class="input-group">
                          <span class="input-group-text @error('phone') border-danger @enderror" id="basic-addon1" >+233</span>
                          <input name="phone" type="tel" maxlength="9" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="User's Contact.." aria-label="Username" aria-describedby="basic-addon1" value="{{ old('phone') ? old('phone') : Auth::user()->phone }}">
    ...
    <div class="text-center mt-5 ">
      ...
      {{-- <button {{ onclick($dispatch('open-modal', 'confirm-user-deletion')) }} >Open</button> --}}
      <!-- Button trigger modal -->
        <button type="button" class="btn btn-outline-danger  w-50" data-bs-toggle="modal" data-bs-target="#exampleModal">
          Delete Account
        </button>
            ...
            <div class="modal-content">
              <form method="post" action="{{ route('profile.destroy') }}">
                ...
                <div class="modal-header me-0">
                  <h2 class="modal-title fs-5" id="exampleModalLabel">Are you sure you want to delete your account?</h2>
                ...
                <div class="modal-body ms-0">
                  ...
                  <div class="mb-3 text-start mt-4">
                    <label for="exampleInputUsername1"  class="form-label" style="font-size: 18px;font-weight: 510">Password</label>
